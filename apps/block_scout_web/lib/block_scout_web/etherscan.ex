defmodule BlockScoutWeb.Etherscan do
  ...
  @token_model %{
    ...
    fields: %{
      ...
      type: %{
        type: "token type",
        enum: ~s(["ERC-20", "ERC-721", "ARC-20", "ARC-721"]),
        enum_interpretation: %{"ERC-20" => "ERC-20 token standard", "ERC-721" => "ERC-721 token standard", "ARC-20" => "ARC-20 token standard", "ARC-721" => "ARC-721 token standard"}
      },
      cataloged: %{
        type: "boolean",
